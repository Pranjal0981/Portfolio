...
Family matters: Issues like divorce, child custody, and maintenance.    </p> 
...
Regulatory issues: Challenges to regulations or administrative decisions affecting individuals or businesses.                    </p>
...
Conservation efforts: Cases related to the preservation of natural resources and wildlife.                    </p>
                    <button onClick={handleClick}>Learn More</button>
                </motion.div>
                <motion.div className="box" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} initial={{ opacity: 0, y: 50 }} animate={containerAnimation}>
                    <h2>The Arbitration and Conciliation
</h2>
                    <p>
